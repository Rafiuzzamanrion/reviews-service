...
export default function OrderTable({ orders, onRefill, isAdmin, onStatusUpdate }) {
                    ...
                    {isAdmin ? (
                      ...
                      order.refillRequest?.requested ? (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.97 }}
                          onClick={() => onRefill && onRefill(order)}
                      ...
                      // User View
                      order.refillRequest?.requested ? (
                        <span className={`text-xs font-bold px-3 py-1.5 rounded-full ${refillStyles[order.refillRequest.status]}`}>
                          Refill: {order.refillRequest.status}
                        </span>
                      ) : (
                        <motion.button
